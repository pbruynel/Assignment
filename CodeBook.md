...
repository. The script writes the dataset to a csv-file named 'allData.csv'. This 
...
The script writes this dataset to a csv-file named 'avgSubjectActivityData.csv'. 
