...
## Creation
The *allData* dataset is generated by the *run_analysis.R* R-script. The script 
writes the dataset to a file named *allData.csv*. This file is included in the 
repository.  
...
It is provided in the repository in the directory 'UCI HAR Dataset' for your convenience.  
...
After unpacking the downloaded zip-file you can run the script *run_analysis*. To create a tidy 
...
The script writes this dataset to a file named *avgSubjectActivityData.csv*. This 
file is also included in the repository.
