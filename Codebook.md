...
writes the dataset to a file named *allData.csv*.  
...
It is provided in the directory 'UCI HAR Dataset' for your convenience.  
...
The script writes this dataset to a file named *avgSubjectActivityData.csv*.  
